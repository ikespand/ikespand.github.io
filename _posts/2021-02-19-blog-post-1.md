...
3. Finally, we can take the inspiration from the already [mentioned blog ](https://towardsdatascience.com/map-matching-done-right-using-valhallas-meili-f635ebd17053 "mentioned blog ")to automatize things in Python. Find a notebook here with detailed comments [ToDo].
