...
<img style="float: right;" src="https://firebase.google.com/downloads/brand-guidelines/PNG/logo-vertical.png"> 
[Firebase](https://firebase.google.com/) is a Backend-as-a-Service (BaaS) app development platform backed by Google. It provides a variety of services like database, cloud storage etc. Most prominent use case is having a realtime database in almost no time to enable quick prototyping.
