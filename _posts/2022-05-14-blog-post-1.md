...
date: 2022-05-14
permalink: /posts/firebase-pyrebase/
tags:
  - Firebase
  - Python
  - Realtime Database
...
# First impression with Firebase Realtime Database using Python
<img style="float: right;" src="https://upload.wikimedia.org/wikipedia/commons/3/37/Firebase_Logo.svg">
Firebase is a Backend-as-a-Service (BaaS) app development platform backed by Google. It provides a variety of services like database, cloud storage etc. Most prominent use case is having a realtime database in almost no time to enable quick prototyping.
