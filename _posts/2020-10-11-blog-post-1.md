...
This will start a Java based navigation service and can be viewed with `localhost:8080` in the browser. This service would also enable us to inquire data via its REST API. E.g.
```bash
...
`
With this basic setup, one can build a service or an application. 
...
This file will overwrite the default settings. For a detailed list of the keywords, refer to official [document](https://docs.opentripplanner.org/en/latest/Configuration/#runtime-router-configuration "document").
